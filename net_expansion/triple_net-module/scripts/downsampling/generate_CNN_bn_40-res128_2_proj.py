...
def create_neural_net(input_file, batch_size=50):
    ...
    [net.res256_2_proj, net.bn2_5, net.scale2_5, net.conv256_3, net.bn2_6, net.scale2_6, 
     ...
     net.relu256_to_128] = add_downsampling_block(net.res256_7, 24)
    ## block 4 cur
    ...
    #     net.relu128_to_64] = add_downsampling_block(net.res128_7, 48)
    [net.res128_2_proj, net.bn2_10, net.scale2_10] = add_module(net.res128_7, 2*48, 2)
    ## block 6
    [net.conv64_1, net.bn2_13, net.scale2_13, net.relu64_1, net.conv64_2, net.bn2_14, 
     net.scale2_14, net.res64_2, net.relu64_2] = add_skip_block(net.res128_2_proj, 96)
    ## block 6_1
    ...
    [net.res64_2_proj, net.bn2_15, net.scale2_15, net.conv64_3, net.bn2_16, net.scale2_16, 
     ...
     net.relu64_to_32] = add_downsampling_block(net.res64_7, 96)
    ## block 8
    ...
    [net.res32_2_proj, net.bn2_20, net.scale2_20, net.conv32_3, net.bn2_21, net.scale2_21, 
     ...
     net.relu32_to_16] = add_downsampling_block(net.res32_7, 192)
    ## block 10
