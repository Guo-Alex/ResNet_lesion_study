...
def create_neural_net(input_file, batch_size=50):
    ...
    [net.conv256_6, net.bn4_1, net.scale4_1, net.relu256_6, net.conv256_7, net.bn4_2, 
     net.scale4_2, net.res256_7, net.relu256_7] = add_skip_block(net.res512_to_256, 24)
    ## block 2_3
    ...
    [net.conv256_4, net.bn3_1, net.scale3_1, net.relu256_4, net.conv256_5, net.bn3_2, 
     net.scale3_2, net.res256_5, net.relu256_5] = add_skip_block(net.res256_9, 24)
    ## block 2
    [net.conv256_1, net.bn2_3, net.scale2_3, net.relu256_1, net.conv256_2, net.bn2_4, 
     net.scale2_4, net.res256_2, net.relu256_2] = add_skip_block(net.res256_5, 24)
    ## block 3
    ...
    [net.conv128_8, net.bn5_3, net.scale5_3, net.relu128_8, net.conv128_9, net.bn5_4, 
     net.scale5_4, net.res128_9, net.relu128_9] = add_skip_block(net.res256_to_128, 48)
    ## block 4_2
    [net.conv128_6, net.bn4_3, net.scale4_3, net.relu128_6, net.conv128_7, net.bn4_4, 
     net.scale4_4, net.res128_7, net.relu128_7] = add_skip_block(net.res128_9, 48)
    ## block 4_1
    [net.conv128_4, net.bn3_3, net.scale3_3, net.relu128_4, net.conv128_5, net.bn3_4, 
     net.scale3_4, net.res128_5, net.relu128_5] = add_skip_block(net.res128_7, 48)
    ## block 4 
    [net.conv128_1, net.bn2_8, net.scale2_8, net.relu128_1, net.conv128_2, net.bn2_9, 
     net.scale2_9, net.res128_2, net.relu128_2] = add_skip_block(net.res128_5, 48)
    ## block 5
    ...
    [net.conv64_8, net.bn5_5, net.scale5_5, net.relu64_8, net.conv64_9, net.bn5_6, 
     net.scale5_6, net.res64_9, net.relu64_9] = add_skip_block(net.res128_to_64, 96)
    ## block 6_2
    [net.conv64_6, net.bn4_5, net.scale4_5, net.relu64_6, net.conv64_7, net.bn4_6, 
     net.scale4_6, net.res64_7, net.relu64_7] = add_skip_block(net.res64_9, 96)
    ## block 6_1
    [net.conv64_4, net.bn3_5, net.scale3_5, net.relu64_4, net.conv64_5, net.bn3_6, 
     net.scale3_6, net.res64_5, net.relu64_5] = add_skip_block(net.res64_7, 96)
    ## block 6
    [net.conv64_1, net.bn2_13, net.scale2_13, net.relu64_1, net.conv64_2, net.bn2_14, 
     net.scale2_14, net.res64_2, net.relu64_2] = add_skip_block(net.res64_5, 96)
    ## block 7
    ...
    [net.conv32_8, net.bn5_7, net.scale5_7, net.relu32_8, net.conv32_9, net.bn5_8, 
     net.scale5_8, net.res32_9, net.relu32_9] = add_skip_block(net.res64_to_32, 192)
    ## block 8_2
    [net.conv32_6, net.bn4_7, net.scale4_7, net.relu32_6, net.conv32_7, net.bn4_8, 
     net.scale4_8, net.res32_7, net.relu32_7] = add_skip_block(net.res32_9, 192)
    ## block 8_1
    [net.conv32_4, net.bn3_7, net.scale3_7, net.relu32_4, net.conv32_5, net.bn3_8, 
     net.scale3_8, net.res32_5, net.relu32_5] = add_skip_block(net.res32_7, 192)
    ## block 8
    [net.conv32_1, net.bn2_18, net.scale2_18, net.relu32_1, net.conv32_2, net.bn2_19, 
     net.scale2_19, net.res32_2, net.relu32_2] = add_skip_block(net.res32_5, 192)
    ## block 9
    ...
    [net.conv16_7, net.bn5_9, net.scale5_9, net.relu16_7, net.conv16_8, net.bn5_10, 
     net.scale5_10, net.res16_8, net.relu16_8] = add_skip_block(net.res32_to_16, 384)
    ## block 10_2
    [net.conv16_5, net.bn4_9, net.scale4_9, net.relu16_5, net.conv16_6, net.bn4_10, 
     net.scale4_10, net.res16_6, net.relu16_6] = add_skip_block(net.res16_8, 384)
    ## block 10_1
    [net.conv16_3, net.bn3_9, net.scale3_9, net.relu16_3, net.conv16_4, net.bn3_10, 
     net.scale3_10, net.res16_4, net.relu16_4] = add_skip_block(net.res16_6, 384)
     ## block 10
