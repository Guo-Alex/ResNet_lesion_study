...
def create_neural_net(input_file, batch_size=50):
    ...
    #     net.scale6_10, net.res256_19, net.relu256_19] = add_skip_block(net.res256_17, 24)
    ## block 3
    [net.res256_2_proj, net.bn2_5, net.scale2_5, net.conv256_3, net.bn2_6, net.scale2_6, 
     ...
     net.relu256_to_128] = add_downsampling_block(net.res256_11, 24)
    ## block 4 
    ...
    [net.res128_2_proj, net.bn2_10, net.scale2_10, net.conv128_3, net.bn2_11, net.scale2_11, 
     ...
     net.relu128_to_64] = add_downsampling_block(net.res128_11, 48)
    ## block 6
    ...
    [net.res64_2_proj, net.bn2_15, net.scale2_15, net.conv64_3, net.bn2_16, net.scale2_16, 
     ...
     net.relu64_to_32] = add_downsampling_block(net.res64_11, 96)
    ## block 8
    ...
    [net.res32_2_proj, net.bn2_20, net.scale2_20, net.conv32_3, net.bn2_21, net.scale2_21, 
     ...
     net.relu32_to_16] = add_downsampling_block(net.res32_11, 192)
    ## block 10
    ...
    net.global_pool = L.Pooling(net.res16_10, pool=AVE, kernel_size=8, stride=1)
