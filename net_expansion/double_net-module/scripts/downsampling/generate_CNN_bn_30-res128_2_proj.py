...
def create_neural_net(input_file, batch_size=50):
    ...
    [net.res256_2_proj, net.bn2_5, net.scale2_5, net.conv256_3, net.bn2_6, net.scale2_6, 
     ...
     net.relu256_to_128] = add_downsampling_block(net.res256_5, 24)
    ## block 4 
    ...
    ##     net.relu128_to_64] = add_downsampling_block(net.res128_5, 48)
    [net.res128_2_proj, net.bn2_10, net.scale2_10] = add_module(net.res128_5, 2*48, 2)
    ## block 6
