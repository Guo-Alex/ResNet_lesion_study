...
def create_neural_net(input_file, batch_size=50):
    ...
    ## block 2_4
    [net.conv256_10, net.bn6_1, net.scale6_1, net.relu256_10, net.conv256_11, net.bn6_2, 
     net.scale6_2, net.res256_11, net.relu256_11] = add_skip_block(net.res256_9, 24)
    ## block 2_5
    [net.conv256_12, net.bn7_1, net.scale7_1, net.relu256_12, net.conv256_13, net.bn7_2, 
     net.scale7_2, net.res256_13, net.relu256_13] = add_skip_block(net.res256_11, 24)
    ## block 2_6
    [net.conv256_14, net.bn8_1, net.scale8_1, net.relu256_14, net.conv256_15, net.bn8_2, 
     net.scale8_2, net.res256_15, net.relu256_15] = add_skip_block(net.res256_13, 24)
    ## block 2_7
    [net.conv256_16, net.bn9_1, net.scale9_1, net.relu256_16, net.conv256_17, net.bn9_2, 
     net.scale9_2, net.res256_17, net.relu256_17] = add_skip_block(net.res256_15, 24)
    ## block 2_8
    [net.conv256_18, net.bn10_1, net.scale10_1, net.relu256_18, net.conv256_19, net.bn10_2, 
     net.scale10_2, net.res256_19, net.relu256_19] = add_skip_block(net.res256_17, 24)
    ## block 3
    [net.res256_2_proj, net.bn2_5, net.scale2_5, net.conv256_3, net.bn2_6, net.scale2_6, 
     ...
     net.relu256_to_128] = add_downsampling_block(net.res256_19, 24)
    ## block 4 
    ...
    ## block 4_4
    [net.conv128_10, net.bn6_3, net.scale6_3, net.relu128_10, net.conv128_11, net.bn6_4, 
     net.scale6_4, net.res128_11, net.relu128_11] = add_skip_block(net.res128_9, 48)
    ## block 4_5
    [net.conv128_12, net.bn7_3, net.scale7_3, net.relu128_12, net.conv128_13, net.bn7_4, 
     net.scale7_4, net.res128_13, net.relu128_13] = add_skip_block(net.res128_11, 48)
    ## block 4_6
    [net.conv128_14, net.bn8_3, net.scale8_3, net.relu128_14, net.conv128_15, net.bn8_4, 
     net.scale8_4, net.res128_15, net.relu128_15] = add_skip_block(net.res128_13, 48)
    ## block 4_7
    [net.conv128_16, net.bn9_3, net.scale9_3, net.relu128_16, net.conv128_17, net.bn9_4, 
     net.scale9_4, net.res128_17, net.relu128_17] = add_skip_block(net.res128_15, 48)
    ## block 4_8
    [net.conv128_18, net.bn10_3, net.scale10_3, net.relu128_18, net.conv128_19, net.bn10_4, 
     net.scale10_4, net.res128_19, net.relu128_19] = add_skip_block(net.res128_17, 48)
    ## block 5
    [net.res128_2_proj, net.bn2_10, net.scale2_10, net.conv128_3, net.bn2_11, net.scale2_11, 
     ...
     net.relu128_to_64] = add_downsampling_block(net.res128_19, 48)
    ## block 6
    ...
    ## block 6_4
    [net.conv64_10, net.bn6_5, net.scale6_5, net.relu64_10, net.conv64_11, net.bn6_6, 
     net.scale6_6, net.res64_11, net.relu64_11] = add_skip_block(net.res64_9, 96)
    ## block 6_5
    [net.conv64_12, net.bn7_5, net.scale7_5, net.relu64_12, net.conv64_13, net.bn7_6, 
     net.scale7_6, net.res64_13, net.relu64_13] = add_skip_block(net.res64_11, 96)
    ## block 6_6
    [net.conv64_14, net.bn8_5, net.scale8_5, net.relu64_14, net.conv64_15, net.bn8_6, 
     net.scale8_6, net.res64_15, net.relu64_15] = add_skip_block(net.res64_13, 96)
    ## block 6_7
    [net.conv64_16, net.bn9_5, net.scale9_5, net.relu64_16, net.conv64_17, net.bn9_6, 
     net.scale9_6, net.res64_17, net.relu64_17] = add_skip_block(net.res64_15, 96)
    ## block 6_8
    [net.conv64_18, net.bn10_5, net.scale10_5, net.relu64_18, net.conv64_19, net.bn10_6, 
     net.scale10_6, net.res64_19, net.relu64_19] = add_skip_block(net.res64_17, 96)
    ## block 7
    [net.res64_2_proj, net.bn2_15, net.scale2_15, net.conv64_3, net.bn2_16, net.scale2_16, 
     ...
     net.relu64_to_32] = add_downsampling_block(net.res64_19, 96)
    ## block 8
    ...
    ## block 8_4
    [net.conv32_10, net.bn6_7, net.scale6_7, net.relu32_10, net.conv32_11, net.bn6_8, 
     net.scale6_8, net.res32_11, net.relu32_11] = add_skip_block(net.res32_9, 192)
    ## block 8_5
    [net.conv32_12, net.bn7_7, net.scale7_7, net.relu32_12, net.conv32_13, net.bn7_8, 
     net.scale7_8, net.res32_13, net.relu32_13] = add_skip_block(net.res32_11, 192)
    ## block 8_6
    [net.conv32_14, net.bn8_7, net.scale8_7, net.relu32_14, net.conv32_15, net.bn8_8, 
     net.scale8_8, net.res32_15, net.relu32_15] = add_skip_block(net.res32_13, 192)
    ## block 8_7
    [net.conv32_16, net.bn9_7, net.scale9_7, net.relu32_16, net.conv32_17, net.bn9_8, 
     net.scale9_8, net.res32_17, net.relu32_17] = add_skip_block(net.res32_15, 192)
    ## block 8_8
    [net.conv32_18, net.bn10_7, net.scale10_7, net.relu32_18, net.conv32_19, net.bn10_8, 
     net.scale10_8, net.res32_19, net.relu32_19] = add_skip_block(net.res32_17, 192)
    ## block 9
    [net.res32_2_proj, net.bn2_20, net.scale2_20, net.conv32_3, net.bn2_21, net.scale2_21, 
     ...
     net.relu32_to_16] = add_downsampling_block(net.res32_19, 192)
    ## block 10
    ...
    ## block 10_4
    [net.conv16_9, net.bn6_9, net.scale6_9, net.relu16_9, net.conv16_10, net.bn6_10, 
     net.scale6_10, net.res16_10, net.relu16_10] = add_skip_block(net.res16_8, 384)
    ## block 10_5
    [net.conv16_11, net.bn7_9, net.scale7_9, net.relu16_11, net.conv16_12, net.bn7_10, 
     net.scale7_10, net.res16_12, net.relu16_12] = add_skip_block(net.res16_10, 384)
    ## block 10_6
    [net.conv16_13, net.bn8_9, net.scale8_9, net.relu16_13, net.conv16_14, net.bn8_10, 
     net.scale8_10, net.res16_14, net.relu16_14] = add_skip_block(net.res16_12, 384)
    ## block 10_7
    [net.conv16_15, net.bn9_9, net.scale9_9, net.relu16_15, net.conv16_16, net.bn9_10, 
     net.scale9_10, net.res16_16, net.relu16_16] = add_skip_block(net.res16_14, 384)
    ## block 10_8
    [net.conv16_17, net.bn10_9, net.scale10_9, net.relu16_17, net.conv16_18, net.bn10_10, 
     net.scale10_10, net.res16_18, net.relu16_18] = add_skip_block(net.res16_16, 384)
    
    ## global pool
    AVE = caffe_pb2.PoolingParameter.AVE
    net.global_pool = L.Pooling(net.res16_18, pool=AVE, kernel_size=8, stride=1)
